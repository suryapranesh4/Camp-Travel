      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 relative w-full flex justify-end">
        ...
        <div className="z-20 flex w-full flex-col lg:w-[60%]">
          <div className="relative">
            ...
            />
            <h2 className="text-[40px] font-[700] leading-[120%] lg:text-[64px] font-[700] leading-[120%]">
              Our Features
            </h2>
          </div>
...
const FeatureItem = ({ title, icon, description }: FeatureItem) => {
  return (
    <li className="flex w-full flex-1 flex-col items-start">
      ...
      <p className="text-[16px] font-[400] mt-5 bg-white/80 text-gray-400 lg:mt-[30px] lg:bg-none">
        {description}
      </p>
    </li>
  );
